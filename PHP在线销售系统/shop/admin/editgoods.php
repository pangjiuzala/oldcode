...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="75" bgcolor="#666666"><table width="750" height="86" border="0" cellpadding="0" cellspacing="1">
	  ...
	  <tr>
        <td height="20" colspan="10" bgcolor="#666666"><div align="center" class="style1">商品信息编辑</div></td>
      </tr>
      <tr>
...
<table width="750" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="165">
	  <div align="left"><input type="submit" value="删除选择" class="buttoncss">&nbsp;<input type="reset" value="重新选择" class="buttoncss"></div></td>
