...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="20" bgcolor="#666666"><div align="center" class="style1">查看订单 </div></td>
  </tr>
  <tr>
    <td height="40" bgcolor="#666666"><table width="750" height="44" border="0" align="center" cellpadding="0" cellspacing="1">
      ...
      <tr>
        ...
        <td height="21" bgcolor="#FFFFFF"><div align="center">
		    <input type="button" value="查看" onClick="javascript:window.open('showdd?id=<?php echo $info1["id"];?>','newframe','width=600,height=<?php echo $sum;?>,left=100,top=100,menubar=no,toolbar=no,location=no,scrollbars=no')" class="buttoncss">&nbsp;
		    <input type="button" value="执行" onClick="javascript:window.location='orderdd.php?id=<?php echo $info1["id"];?>';" class="buttoncss">       
