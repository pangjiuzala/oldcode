...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="20" bgcolor="#666666"><div align="center" class="style1">用户管理</div></td>
  </tr>
  <tr>
    <td  bgcolor="#666666"><table width="599" border="0" align="center" cellpadding="0" cellspacing="1">
       <?php
	     $pagesize=20;
		   if ($total<=$pagesize){
		      $pagecount=1;
	   ...
	   ?>
	   <tr>
          <td width="254" height="20" bgcolor="#FFFFFF"><div align="center">用户昵称</div></td>
          <td width="123" bgcolor="#FFFFFF"><div align="center">用户状态</div></td>
          <td width="109" bgcolor="#FFFFFF"><div align="center">删除</div></td>
          <td width="105" bgcolor="#FFFFFF"><div align="center">查看信息</div></td>
        </tr>
       <?php
