  ...
  <tr>
    ...
    <td width="590" valign="top"><table width="550" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <?php
       ...
       $sql=mysql_query("select count(*) as total from shangpin where tejia=1 ",$conn);
     ...
     <?php
		   ...
		   if ($total<=$pagesize){
			...
			if(($_GET["page"])==""){
             ...
             $sql1=mysql_query("select * from shangpin where tejia=1 order by addtime desc limit ".($page-1)*$pagesize.",$pagesize ",$conn);
      ...
      <table width="550" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <?php
		  ...
		  {
		  ?>
        <a href="showtejia.php?page=1" title="首页"><font face="webdings"> 9 </font></a> 
		<a href="showtejia.php?id=<?php echo $id;?>&page=<?php echo $page-1;?>" title="前一页"><font face="webdings"> 7 </font></a>
        <?php
		  }
		   if($pagecount<=4){
        ...
        <a href="showtejia.php?page=<?php echo $i;?>"><?php echo $i;?></a>
        <?php }?>
        <a href="showtejia.php?page=<?php echo $page-1;?>" title="后一页"><font face="webdings"> 8 </font></a> 
		<a href="showtejia.php?id=<?php echo $id;?>&page=<?php echo $pagecount;?>" title="尾页"><font face="webdings"> : </font></a>
        <?php }?>
		  </div></td>
        </tr>
      </table>
