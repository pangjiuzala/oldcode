...
<body>
	<table width="780" height="110" border="0" align="center"
		...
		<tr>
			<td height="15"><div align="center" class="title">
					如果需要开发高档的Java EE应用 ，请登录<a href="http://www.nuc.edu.cn/">中北大学</a>。谢谢
				</div></td>
		</tr>
		<tr>
			<td colspan="3"><br>
				<table width="578" border="0" align="center" cellpadding="0"
					cellspacing="0">
					<tr>
						...
						<td width="70"><a href="index.action">返回首页</a>
							</div></td>
					</tr>
				</table></td>
		</tr>
	...
	<table width="780" border="0" align="center" cellpadding="0"
		cellspacing="0">
		<tr>
			<td background="images/bodybg.jpg"><br> <br>
				<table width="100%" border="0" align="center" cellpadding="0"
					cellspacing="0">
					<tr>
						<td width="283"><img src="images/struts2.png" width="188"
							height="66"></td>
						<td width="246"><img src="images/spring.gif" width="152"
							height="66"></td>
						<td width="243"><img src="images/hibernate.png" width="203"
							height="56"></td>
					</tr>
				</table></td>
		</tr>
		<tr>
			<td height="68" background="images/bodybg.jpg">
				<div align="center">
					All Rights Reserved.<br> 版权所有 Copyright@2015 FanYu<br />
					如有任何问题和建议，请登录<a href="http://www.nuc.edu.cn/">中北大学</a>反映！<br />
